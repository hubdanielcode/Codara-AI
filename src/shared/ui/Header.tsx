  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <Menu
            className={`h-5 w-5 cursor-pointer ${theme === "Dark" ? "text-zinc-500 hover:text-white" : "text-stone-400 hover:text-stone-800"}`}
          />
        </motion.button>
        ...
        >
          <LogOut
            className={`h-5 w-5 cursor-pointer ${theme === "Dark" ? "text-zinc-500 hover:text-white" : "text-stone-500 hover:text-black"}`}
          />
        </motion.button>
      </div>
    </motion.header>
